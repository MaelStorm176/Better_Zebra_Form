...
const ZEBRA_FORM_UPLOAD_RANDOM_NAMES = false;
...
class Zebra_Form
{
     ...
     *  @var    string
     */
    protected string $file_upload_permissions;
     ...
     *  @return void
     */
    public function __construct(string $name, string $method = 'POST', string $action = '', array $attributes = array())
    {
        ...
        require_once __DIR__ . '/includes/XSSClean.php';
     ...
     *  @return void
     */
    public function add_error($error_block, $error_message): void
    {
     ...
     *
     */
    public function auto_fill(array $defaults = array(), bool $specifics_only = false): void
    {
     ...
     *  @return void
     */
    public function clientside_validation($properties): void
    {
     ...
     *  @return void
     */
    public function doctype(string $doctype = 'html'): void
    {
